...
from django.core.validators import EmailValidator, MinValueValidator, URLValidator, RegexValidator, MinLengthValidator
...
class Customer(models.Model):
    ...
    phone_number = models.CharField(
        ...
        validators=[RegexValidator(
            regex=r'^\+359\d{9}$',   # begins with +359, followed by 9 digits, and $ is for end of string
